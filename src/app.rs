...
pub struct App {
    ...
    pub(crate) selected_files: HashSet<String>,
...
impl App {
    pub fn new(root_path: &Path) -> Result<Self, Box<dyn Error>> {
    ...
    pub fn get_display_text(&self, identifier: &str, text: &str) -> String {
...
pub fn render_tree_with_checkboxes<'a>(
